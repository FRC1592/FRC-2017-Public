...
public final class Constants {
	...
	/*
	 * To calc Kf:
	 * 1. run robot at full speed (really needs to be under load - i.e. driving around)
	...
	public final static class Trident {
		public static final int MASTER_CHAN = 2; //F:2, P: 8
		public static final int SLAVE_CHAN = 3; //F: 3, P:9
		public static final int KICKER_CHAN = 9; //F: 9, P:10
		public static final int LIFT_CHAN = 8; //F: 8, P:11
...
//		public static final double shooterF = 0.0192d;
//		public static final double shooterP = 0.07d;
//		public static final double shooterI = 0.0003d;
//		public static final double shooterD = 0d;
//		public static final int    shooterIz = 1000;
//		public static final double shooterRamp = 0d;
		...
		public static final double SHOOTER_RPM = 3034d; //3150
	...
	public final static class Ballarator {
		public static final int GATHER_CHAN = 6; //F:6, P:15
	}
	
	public final static class GearFlapper {
		public static final int GATHER_CHAN = 12; //F:12, P:14
		public static final int FLAP_CHAN = 7; //F: 7, P:12
		public static final int GATHERED_CHAN = 0; //F:0, P:0
		
		public static final double kP = 0.6;
		public static final double kI = 0;
		public static final double kD = 0;
		public static final double OFFSET = 0.822; //F:0.496, P:0.065
