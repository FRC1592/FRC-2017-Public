...
public class DriveWithJoysticksHeading_FPS extends Command {
    ...
    public DriveWithJoysticksHeading_FPS() {
    ...
    protected void execute() {
    	...
    	double z = Discontinuities.joyExpo(zmap,kJoyExpo) * Constants.MAX_TURN_RATE;
    ...
    private static double map(double in, double inLow, double outLow) {
    	double in_mag = (Math.abs(in) - inLow)*(1-outLow)/(1-inLow)+outLow;
